...
return [
    ...
    'notifications' => [
        ...
        'slack' => [
            ...
            'channel' => env('FIREWALL_SLACK_CHANNEL', 'tikety_activities'), // set null to use the default channel of webhook
        ],
