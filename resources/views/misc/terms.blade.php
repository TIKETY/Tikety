...
This Agreement, and use of the website, is an online service provided by Tikety.co.tz,
TIKETY TECHNOLOGIES LIMITED (sometimes referred to herein as the "Company", "we"
or "our") with a principal place of business in Tanzania. The website consists of ticketing
services, which may include facilitation of the purchase or sale of tickets to Bus tickets,
access to other ticket resources, and related content provided by the Company and by third
parties.
This Website is subject to the terms and restrictions contained herein and is for private
personal use by consumers only ("Users"). Any other use or attempt to use this Website, or
any of the services provided through this Website for commercial purposes (including the
purchase of tickets for the purpose of resale), directly or indirectly, by you or by a third party
is strictly prohibited.
<strong>2. Changes in Terms and Conditions</strong>
The Company reserves the right to modify, suspend, or discontinue any aspect or feature of
this Website, or this Agreement at any time. This includes but is not limited to, the right to
change or discontinue any service provided by the Company, content displayed on this
Website, hours of availability, and equipment needed for access or to use this Website, at
any time. Tikety.co.tz shall not be liable to you or any third party for any modification,
suspension, or discontinuance. The failure of Tikety.co.tz to exercise or enforce any right or
provision of these Terms of Use shall not constitute a waiver of such right or provision.
Unless expressly stated otherwise, any new features that augment or enhance the current
services provided though this Website also will be subject to the provisions of this
Agreement.
<strong>3. Permitted Use of This Website</strong>
This Website is the property of TIKETY TECHNOLOGIES LIMITED and your access to this
Website is with our permission. Any unauthorized access or use will be, among other things,
a trespass, and we reserve the right to pursue our legal rights for any unauthorized access or
use of this Website, including seeking civil remedies and equitable relief to the fullest extent
possible, as well as referral of matters to appropriate law enforcement agencies.
<strong>4. Prohibited Use of this Website</strong>
You are prohibited from doing any act that has the effect of undermining the integrity of our
system, this Website, our services and the method by which we provide our services to
users.
a.  As a material term of this Agreement, you expressly agree that you shall NOT do any of the
    following:
    i.      Deploy or facilitate the use or deployment of any robot, spider, scraper or any
            other automated means, method or device to view, select or copy any
            content from this Website;
    ii.     Deploy or facilitate the use or deployment of any script, routine, program or
            any other automated means, method or device with respect to this Website
            for any other purpose, including but not limited to purchasing tickets;
    iii.    Deploy or facilitate the use or deployment of any program, system, means,
            method or device, for any purpose that places an unreasonable, unnecessary
            or excessive demand or load on this Website, its hardware and connections,
            or prohibits, denies or delays access to this Website by others;
    iv.     Purchase any tickets offered through this Website for the purposes of
            reselling those tickets, except as permitted by applicable law. If we determine
            that you are purchasing an irregularly large number of tickets to an event or
            multiple events, we will presume that you are purchasing such tickets for
            resale purposes and at our sole election, we will cancel your transaction(s)
            and restrict your access to this Website;
    v.      Download or copy any content displayed on this Website for purposes other
            than preserving information for your personal use;
    vi.     Establish any deep link or other connection to any specific page or pages of
            this Website other than the home page, without Company's prior written
            permission;
    vii.    Deploy or facilitate the use or deployment of any automatic or manual device,
            process or means to circumvent, avoid or defeat any of our security
            measures or systems, including but not limited to the "CAPTCHA" system
            used as part of this Website's ticket purchasing process. The CAPTCHA
            system requires the typing of characters on your computer screen, and you
            expressly agree that the typing will only be done manually by you on the
            keyboard of the computer you are using to access this Website;
    viii.   Access, reload or refresh this Website's transactional event or ticketing
            pages, or make any other request to this Website's transactional servers,
            more than once during any two second interval; or
    ix.     Request more than 500 pages of this Website in any twenty-four hour period.

b.  You expressly agree that you will use this Website only for lawful purposes. You will
    not post or transmit through this Website any material which:
    i.      Violates or infringes in any way upon the rights of others.
    ii.     Is unlawful, threatening, abusive, defamatory, invasive of privacy or publicity
            rights, vulgar, obscene, profane or otherwise objectionable.
    iii.    Encourages conduct that would constitute a criminal offense, give rise to civil
            liability or otherwise violate any law.
    iv.     Creates or attempts to create any liability of the Company.
    v.      Contains advertising or any solicitation with respect to products or services,
            unless we have approved such material in writing, in advance of its transmission.
    vi.     Introduces any program, executable file or routine (such as a worm, Trojan horse,
            cancelbot, time bomb or virus) into our system for any purpose, irrespective of
            whether any such program or routine results in detrimental harm to our system or
            our data.
    vii.    Threatens the continuous services of our ISP's, suppliers and vendors. Any conduct
            by you that in our sole discretion restricts, inhibits, or interferes with any other
            consumer from using or enjoying this Website is expressly prohibited.
<strong>5. Transaction and Processing Fees</strong>
There is no fee for accessing this Website and viewing our content and the content of third
parties that we display.If you decide to purchase tickets or other merchandise, you agree to pay,
in addition to the price for the ticket or merchandise, other fees and charges that we may impose,
including but not limited to,, convenience fees, processing fees, method of delivery fees and other
miscellaneous fees. The amount of each fee may vary, depending on the tickets or merchandise you
purchase and the method you select to receive your tickets or merchandise. Fees and charges, including
(but not limited to) charges for issuance, convenience, handling, processing, shipping, delivery,
(including but not limited to, charges for Republic Express or other courier delivery), and any other
miscellaneous charges assessed by us represent, among other things, the costs we incur in providing
our goods and services to you. The fees and charges we assess may be greater than our actual cost of
providing those services, and we may retain a portion of all such fees and charges as profit.
You are urged to review all pages displayed during your completion of a purchase. All fees
and charges related to your transaction will be disclosed to you during the purchase process.
If you do not agree to pay the fees or charges associated with your purchase, you may
cancel your transaction.
<strong>6. Links to Other Websites</strong>
We may, from time to time, display icons, graphic or textual links to other websites, or display
selected pages of other websites not affiliated with Tikety.co.tz. Any content, product or
service provided by other websites is under the exclusive control of such third parties and not
TIKETY TECHNOLOGIES LIMITED. Your access to and use of any other Website, and any
transaction in which you engage on any other website, is subject to the applicable user
agreements and privacy policies of that website.

By access and use of any other website, you expressly disclaim all liability of Tikety.co.tz
with respect to your, or third party's actions on these other websites. The Company reserves
the exclusive right and sole discretion to add, decline or remove, without notice, any icon or
link to another website.
<strong>7. Electronic Communications</strong>
...
<strong>8. Downloading Of Intellectual Property</strong>
...
extent of the law.
<strong>9. Disclaimers, Limitation of Liability, Releases</strong>
...
<strong>12. Copyright Compliance</strong>
...
breach.
<strong>15. Binding Arbitration</strong>
...
<strong>16. Legal Proceedings</strong>
