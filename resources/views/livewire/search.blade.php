        ...
        <div class="modal-body">
            <form action="{{ route('search', ['language'=>app()->getLocale()]) }}" method="GET">
                ...
                <div class="input-group">
                    <input wire:model="search" type="text" id="query" value="{{ request()->input('query') }}" class="form-control" placeholder="{{ __('Search Buses') }}" aria-label="Recipient's username" aria-describedby="basic-addon2" name="name">
