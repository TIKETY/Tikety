    ...
    <div class="container align-items-center">
        ...
        <div class="row align-items-center">
            <div class="col-lg-4  col-md-6 padding_top_half text-center text-md-left">
                ...
                <form action="{{ route('makerole', ['language'=>app()->getLocale(), 'role'=>1]) }}" method="POST">
                @csrf
            ...
            <div class="col-lg-4  col-md-6 padding_top_half text-center text-md-left">
                ...
                <form action="{{ route('makerole', ['language'=>app()->getLocale(), 'role'=>2]) }}" method="POST">
                @csrf
            ...
            <div class="col-lg-4  col-md-6 padding_top_half text-center text-md-left">
                ...
                <form action="{{ route('makerole', ['language'=>app()->getLocale(), 'role'=>3]) }}" method="POST">
                @csrf
